...
//    }
    ...
    public static BufferedImage[] chunks(String mainImage,int rows,int cols) throws IOException {

        File file = new File(mainImage); // I have bear.jpg in my working directory
...
//        }
   //     System.out.println("Mini images created");
    ...
    public static BufferedImage stitch(BufferedImage[] buffImages,int rows,int cols){
