...
public class TanhTest {
	...
	public static Collection<Object[]> getparameters() {
		return Arrays.asList(
				new Object[][] { { .1, .0249947929, .940014848 }, { .2, .0499583, .786447 }, { .3, .07485969, .596585 },
						{ .4, .09966799, .419974 }, { .5, .124353, .280414 }, { .6, .1488850, .1807066 },
						{ .7, .17323515, .113812 }, { .8, .1973753, .070650 }, { .9, .22127846, .043464 }, });
	}
