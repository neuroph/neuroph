...
public class NeuralNetworkTraining {
	...
	public void reset() {
        ...
        /**
         * This method checks compatibility of neural network and training set.
         * It compares if the number of inputs and outputs of neural network matches
         * the number of inputs and outputs of training set
         * @param neuralNetwork the neural network that will be compared with input training set
         * @param trainingSet the training set that will be compared with input neural network
         * @return returns boolean value of the comparison test. Returns true
         * if the number of inputs and outputs of the input neural network are
         * the same as the number of inputs and outputs of the input training set
         */
