...
//            // get learning rule that we're listening to
//            LMS learningRule = (LMS) o; // put this in event handler
//
//
...
//
//    private class TrainingSwingWorker extends SwingWorker<Void, LearningInfo> {
//        boolean hasData = false;
//        boolean finnished = false;
//
//        public TrainingSwingWorker() {
//
//        }
//
//        public void setFinnished(boolean finnished) {
...
//        }
//
//        private void addData(LearningInfo learningInfo) {
//            dataQueueBuffer.add(learningInfo);
//            this.hasData = hasData;
//
//            if (hasData == true) {
