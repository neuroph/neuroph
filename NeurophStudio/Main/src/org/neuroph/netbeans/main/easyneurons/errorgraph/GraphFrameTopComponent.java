...
//        setIcon(ImageUtilities.loadImage(ICON_PATH, true));
    ...
    /**
     * Obtain the GraphFrameTopComponent instance. Never call {@link #getDefault} directly!
     */
    ...
    public void componentOpened() {
        SimpleXYChartDescriptor descriptor =
                SimpleXYChartDescriptor.decimal(0, 10, 10, 0.1d, true, VALUES_LIMIT);
...
//        chartSupport.addValues(System.currentTimeMillis(), new long[]{100,200,300});
//        chartSupport.addValues(System.currentTimeMillis(), new long[]{100,200,300});
//        chartSupport.addValues(System.currentTimeMillis(), new long[]{100,200,300});
//        chartSupport.addValues(System.currentTimeMillis(), new long[]{100,200,300});        
...
//        new Generator(chartSupport).start();        
    }
    ...
    public void handleLearningEvent(LearningEvent le) {
        ...
        // get data that we want to display
         ...
         iteration = lr.getCurrentIteration();                   
         err[0] = (long)(learningInfo.getError()* 100);
