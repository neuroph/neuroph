...
public class ViewManager implements
    ...
    private HashMap<DataSet, TrainingSetTopComponent> openedTrainingSets = new HashMap<DataSet, TrainingSetTopComponent>();
    ...
    public void openTrainingSetWindow(DataSet trainingSet) {
        TrainingSetTopComponent trainingSetTopComponent;
