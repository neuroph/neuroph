...
public class NeurophProjectTemplateWizardIteratorRecomender implements WizardDescriptor./*Progress*/InstantiatingIterator {
   ...
   private int index;
    ...
    public NeurophProjectTemplateWizardIteratorRecomender() {
    }

    public static NeurophProjectTemplateWizardIteratorRecomender createIterator() {
        return new NeurophProjectTemplateWizardIteratorRecomender();
    }

       private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
                    new NeurophProjectTemplateWizardPanelRecomender(),};
    }

    private String[] createSteps() {
        return new String[]{
                    NbBundle.getMessage(NeurophProjectTemplateWizardIteratorRecomender.class, "LBL_CreateProjectStep")
                };
    }
