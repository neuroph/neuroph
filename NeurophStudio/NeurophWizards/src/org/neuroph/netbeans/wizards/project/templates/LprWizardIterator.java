...
public class LprWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {
    ...
    public LprWizardIterator() {
    }

    public static LprWizardIterator createIterator() {
        return new LprWizardIterator();
    }
    ...
    private String[] createSteps() {
        return new String[]{
            NbBundle.getMessage(LprWizardIterator.class, "LBL_CreateProjectStep")
        };
    }
