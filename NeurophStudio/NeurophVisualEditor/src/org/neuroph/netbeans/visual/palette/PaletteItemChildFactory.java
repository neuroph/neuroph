 ...
 */
public class PaletteItemChildFactory extends ChildFactory<PaletteItem> {

    private final String iconSize = "24";
    private final String iconSize2 = "32";
    private final String[][] ITEMS = new String[][]{
        ...
        {"Neurons", "org/neuroph/netbeans/visual/palette/icons/CompetitiveNeuron" + iconSize + ".png", "CompetitiveNeuron", "org.neuroph.nnet.comp.neuron.CompetitiveNeuron"},
        {"Neurons", "org/neuroph/netbeans/visual/palette/icons/ThresholdNeuron" + iconSize + ".png", "ThresholdNeuron", "org.neuroph.nnet.comp.neuron.ThresholdNeuron"},
        ...
        {"Learning Rules", "org/neuroph/netbeans/visual/palette/icons/LearningRule.png", "Outstar", "org.neuroph.nnet.learning.OutstarLearning"},
//        {"Learning Rules", "org/neuroph/netbeans/visual/palette/icons/trapezoidtransfer.png", "SimulatedAnnealing", "org.neuroph.nnet.learning.SimulatedAnnealingLearning"},
    };
    ...
    protected boolean createKeys(List<PaletteItem> toPopulate) {
        for (String[] itemString : ITEMS) {
            if (category.getName().equals(itemString[0])) {
                PaletteItem item = new PaletteItem();
                item.setCategory(itemString[0]);
                item.setIcon(itemString[1]);
                item.setTitle(itemString[2]);
                try {
