...
id = "IDEActions.CreateNNetworkWSameInOutAsTset")
@ActionRegistration(iconBase = "IDEActions/new.png",
...
public final class CreateNNetworkWSameInOutAsTset implements ActionListener {
    ...
    private void startWizardIterator() {
        ...
        String input = String.valueOf(context.getTrainingSet().getInputSize());
        String output = String.valueOf(context.getTrainingSet().getOutputSize());
