    ...
    public void actionPerformed(ActionEvent ev) {
        ...
        if (DialogDisplayer.getDefault().notify(wiz) == WizardDescriptor.FINISH_OPTION) {
            ...
            try {
                ...
                DataSet[] tsetArray = context.getTrainingSet().createTrainingAndTestSubsets(Integer.parseInt(numTraining), Integer.parseInt(numTest));
                tsetArray[0].setLabel(context.getTrainingSet().getLabel() + "(" + numTraining + "%)");
                tsetArray[1].setLabel(context.getTrainingSet().getLabel() + "(" + numTest + "%)");
